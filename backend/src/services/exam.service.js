...
// Query Services
export const getAllExams = async (search = '', page = 1, limit = 10, sortOrder = 'DESC') => {
...
export const getPublicExams = async (userId, search = '', page = 1, limit = 10, sortOrder = 'DESC', filters = {}) => {
    const offset = (page - 1) * limit;
...
export const getQuestionsByExamId = async (examId, search = '', page = 1, limit = 10, sortOrder = 'desc') => {
    const offset = (page - 1) * limit;
