    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-2 sm:p-4">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-6xl max-h-[90vh] flex flex-col">
                {/* Header */}
                <div className="bg-emerald-600 text-white py-3 sm:py-4 px-3 sm:px-6 rounded-t-xl flex justify-between items-center sticky top-0 z-10">
                    <h2 className="text-lg sm:text-2xl font-bold">Lịch học tuần này</h2>
                ...
                <div className="overflow-auto flex-grow">
                    <div className="min-w-[800px]"> {/* Minimum width to ensure horizontal scrolling on mobile */}
                        ...
                        {/* Calendar body */}
                        <div className="grid grid-cols-[6rem_repeat(7,1fr)] min-h-[56rem]">
                ...
                {/* Footer */}
                <div className="bg-gray-50 px-3 sm:px-6 py-2 sm:py-4 rounded-b-xl text-center">
                    <p className="text-xs sm:text-sm text-gray-500">
                        * Lịch học có thể thay đổi. Vui lòng kiểm tra thường xuyên để cập nhật thông tin mới nhất.
                    </p>
                </div>
            </div>
        </div>
